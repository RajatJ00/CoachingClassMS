Public Class Customer
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        If txtcmob.Text <> "" And txtcname.Text <> "" And txtcadd.Text <> "" And txtcemail.Text <> "" Then
            Module1.insert_update("insert into Student values('" & txtcmob.Text & "','" & txtcname.Text & "','" & txtcadd.Text & "','" & txtcemail.Text & "')")
            MsgBox("Student Added", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "Student Added")
            Emptyfields()
        Else
