Public Class frmStaff
    ...
    Private Sub frmStaff_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtp2.MinDate = Today
        dsemp.Clear()
        daemp = New OleDb.OleDbDataAdapter("select * from Staff", con)
        daemp.Fill(dsemp)
    ...
    Private Sub Button12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button12.Click
        Module1.scalarquery("select max(emp_id)+1 from Staff")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtemail.Text <> "" And txtadd.Text <> "" And txtlv.Text <> "" And txtmo.Text <> "" And txtname.Text <> "" And txtsal.Text <> "" Then
            ...
            Module1.insert_update("insert into Staff values(" & CInt(txtid.Text) & ",'" & txtname.Text & "','" & txtadd.Text & "','" & txtemail.Text & "','" & txtmo.Text & "','" & ComboBox4.Text & "','" & dtp2.Value & "','" & txtsal.Text & "'," & CInt(txtlv.Text) & ",'" & dtp1.Value & "')")
            MsgBox("Staff Added")
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        End Try
        daemp = New OleDb.OleDbDataAdapter("Select * from Staff where emp_id=" & empid & "", con)
        daemp.Fill(dsemp)
    ...
    Private Sub btnUpdate_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If txtemail.Text <> "" And txtadd.Text <> "" And txtlv.Text <> "" And txtmo.Text <> "" And txtname.Text <> "" And txtsal.Text <> "" Then
            'Module1.upinquery("insert into employee values(" & (txtadd.Text) & ",'" & txtname.Text & "','" & txtadd.Text & "','" & txtemail.Text & "')")
            Module1.insert_update("update Staff set em_name='" & txtname.Text & "',emp_address='" & txtadd.Text & "',emp_email='" & txtemail.Text & "',emp_mobile='" & txtmo.Text & "',emp_sal='" & txtsal.Text & "',emp_leaves=" & CInt(txtlv.Text) & " where emp_id=" & CInt(txtid.Text) & "")
